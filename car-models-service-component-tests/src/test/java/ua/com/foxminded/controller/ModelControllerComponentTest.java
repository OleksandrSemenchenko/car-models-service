...
import static ua.com.foxminded.service.imp.ModelServiceImp.MODEL_ALREADY_EXISTS;
import static ua.com.foxminded.service.imp.ModelServiceImp.NO_MODEL_WITH_SUCH_ID;
import static ua.com.foxminded.service.imp.ModelServiceImp.NO_SUCH_MODEL;
...
class ModelControllerComponentTest extends ComponentTestContext {
  ...
  void getByManufacturerAndNameAndYear_ShouldReturnStatus404_WhenNoSuchModel() {
    webTestClient
        ...
        .expectBody()
        .jsonPath("$.message")
        .isEqualTo(String.format(NO_SUCH_MODEL, MANUFACTURER_NAME, MODEL_NAME, NEW_MODEL_YEAR));
  }
  ...
  void update_ShouldReturnStatus404_WhenNoSuchModel() {
    ...
    webTestClient
        ...
        .expectBody()
        .jsonPath("$.message")
        .isEqualTo(String.format(NO_SUCH_MODEL, MANUFACTURER_NAME, NEW_MODEL_NAME, MODEL_YEAR));
  }
