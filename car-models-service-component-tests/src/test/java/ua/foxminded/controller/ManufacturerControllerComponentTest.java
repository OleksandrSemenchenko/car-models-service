...
import static ua.foxminded.cars.service.ManufacturerService.MANUFACTURER_ALREADY_EXISTS;
...
class ManufacturerControllerComponentTest extends ComponentTestContext {
  ...
  void getByName_ShouldReturnStatus404_WhenNoSuchManufacturer() {
    webTestClient
        .get()
        .uri("/v1/manufacturers/{manufacturer}", NEW_MANUFACTURER_NAME)
        ...
        .expectBody()
        .jsonPath("$.message")
        .isEqualTo(String.format(NO_MANUFACTURER, NEW_MANUFACTURER_NAME));
  }
  ...
  void getByName_ShouldReturnStatus200() {
    webTestClient
        .get()
        .uri("/v1/manufacturers/{manufacturer}", MANUFACTURER_NAME)
        .header(AUTHORIZATION_HEADER, getAdminRoleBearerToken())
        .exchange()
        .expectStatus()
        .isOk()
  ...
  void create_ShouldReturnStatus409_WhenManufacturerAlreadyExists() throws JsonProcessingException {
    ...
    webTestClient
        ...
        .expectBody()
        .jsonPath("$.message")
        .isEqualTo(String.format(MANUFACTURER_ALREADY_EXISTS, MANUFACTURER_NAME));
  }
  ...
  void create_ShouldReturnStatus201() throws JsonProcessingException {
    ...
    webTestClient
        ...
        .isCreated()
        .expectHeader()
        .location(carModelServiceBaseUrl + "/v1/manufacturers/" + NEW_MANUFACTURER_NAME);
  }
  ...
  void delete_ShouldReturnStatus405_WhenManufacturerHasRelations() {
    webTestClient
        ...
        .expectBody()
        .jsonPath("$.message")
        .isEqualTo(String.format(DATA_INTEGRITY_VIOLATION_EXCEPTION_MESSAGE, MANUFACTURER_NAME));
  }
  ...
  void delete_ShouldReturnStatus204_WhenManufacturerExists() {
    webTestClient
        .delete()
        .uri("/v1/manufacturers/{manufacturer}", MANUFACTURER_NAME_WITHOUT_RELATIONS)
        .header(AUTHORIZATION_HEADER, getAdminRoleBearerToken())
        .exchange()
        .expectStatus()
        .isNoContent()
